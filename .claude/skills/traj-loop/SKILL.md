---
description: Top-level orchestration for multi-round trajectory optimization. Supports
  semi-auto (interactive CLI-1) and fully-auto (non-interactive CLI-1 + auto-approve
  patches) modes.
metadata:
  categories:
  - trajectory
