---
name: traj-optimize
description: Generates skill-bank patches from trajectory analysis reports. Converts optimization suggestions into standard patch files for human review and compilation.
metadata:
  version: "1.0.0"
  categories:
    - trajectory
