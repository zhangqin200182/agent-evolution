...
description: CLI-2 orchestrator for the dual-CLI architecture. Reads training trajectories, segments, analyzes, and generates skill patches. Runs in a separate CLI session from rllm-train.
metadata:
  version: "1.0.0"
  categories:
    - trajectory
