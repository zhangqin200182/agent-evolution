...
description: SSH connection management for remote NPU training server. Standardizes connection setup, verification, and troubleshooting across all remote skills.
metadata:
  version: "1.0.0"
  categories:
    - infrastructure
