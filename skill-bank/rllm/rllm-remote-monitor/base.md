...
description: Monitor remote NPU training progress via SSH. Tracks reward trends, loss, and detects anomalies (OOM, driver errors, HCCL timeout) on Huawei Ascend servers.
metadata:
  version: "1.0.0"
  categories:
    - machine-learning
